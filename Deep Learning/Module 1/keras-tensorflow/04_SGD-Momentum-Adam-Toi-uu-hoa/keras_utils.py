...
build_model() dung kien truc co dinh [8, 5, 2, 1] giong het bai 04 (NumPy) - bai tap chinh cua
notebook nay la chon/cau hinh OPTIMIZER (get_optimizer), khong phai kien truc.
"""
...
def build_model(input_dim):
    """Kien truc co dinh [input_dim, 5, 2, 1] giong het bai 04 (NumPy), khoi tao kieu He."""
...
def compile_and_train(model, X_train, Y_train, optimizer, epochs=100, batch_size=None, verbose=0):
    ...
    batch_size=64 tuong duong random_mini_batches(..., mini_batch_size=64) o bai 04 - Keras
    tu chia mini-batch (va tu shuffle moi epoch) thay vi ban tu viet random_mini_batches().
    """
